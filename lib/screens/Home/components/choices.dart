...
//  if (check_connectivity(this.context) == false) {
// ////////////////////////////////////////////////////////////////////////
//                         ///
//                         _loadCodeData();
//                         group_code_no_dublicate = [];
//                         for (var i = 0; i < code_data.length; i++) {
//                           if (!group_code_no_dublicate
//                                   .contains(code_data[i].code) &&
//                               code_data[i].groupid == '${mygroup_id}') {
//                             group_code_no_dublicate.add(code_data[i].code!);
//                             print('sqflite group_code_no_dublicate');
//                             print(group_code_no_dublicate);
//                           }
//                         }
//                         for (var i = 0;
//                             i < group_code_no_dublicate.length;
//                             i++) {
//                           if (res == group_code_no_dublicate[i]) {
// // try{
//                             print('sqflite group_code_no_dublicate');
//                             print(group_code_no_dublicate);
//                             // presence
...
class _ChoicesState extends State<Choices> {
  ...
  ScrollController _sc5 = new ScrollController();
  void dispose() {
    _sc1.dispose();
    _sc2.dispose();
    _sc3.dispose();
  ...
  void initState() {
    ...
    //       // GroupManager group_manager = new GroupManager();
    //       await Provider.of<GroupManager>(this.context, listen: false)
    //           .get_all_students_offline(GroupManager.all_groups_offline[i].id!)
    //           .then((value) {
    //         // print('group name');
    //         print('group nametttttttttttttt');
    //         print(GroupManager.stagesList);
    ...
    //       for (var d = 0; d < GroupManager.my_all_groups.length; d++) {
    //         print(GroupManager.my_all_groups[d].id!);
    //       }
    ...
    //     });
    //     print('whatttttttttttttttttttt');
    //     print(GroupManager.my_all_groups);
    //   } catch (e) {}
    // });
    // //
    // print('GroupManager.groupsoffline.length');
    ...
    //       GroupManager group_manager = new GroupManager();
    //       await Provider.of<GroupManager>(this.context, listen: false)
    //           .get_all_students_offline(GroupManager.my_all_groups[d].id!)
    //           .then((value) {
    //         // print('group name');
    //         print('group nametttttttttttttt');
    //         print(GroupManager.my_all_groups.length);
    //         //print(group_manager.groups);
    //         setState(() {
    //           _isloadingyears = false;
    //         });
    ...
    //         for (var k = 0; k < GroupManager.stagesList.length; k++) {
    //           _addCodeData(GroupManager.stagesList[k]['code']['code'],
    //               '${GroupManager.my_all_groups[k].id}');
    //         }
    //       });
    //     } catch (e) {}
    //   });
    ...
    //       GroupManager group_manager = new GroupManager();
    //       await Provider.of<GroupManager>(this.context, listen: false)
    //           .get_group_offline(GroupManager.my_all_groups[d].id!)
    //           .then((value) {
    //         print('group data');
    ...
    //           //   // );
    //           _addData(
    //             GroupManager.my_all_groups[d].year!.name!,
    //             GroupManager.my_all_groups[d].subject!.name!,
    //             GroupManager.my_all_groups[d].teacher!.name!,
    //             GroupManager.my_all_groups[d].name!,
    //             GroupManager.group_info['appointments'][j]['name'],
    //             ' ${GroupManager.my_all_groups[d].id}',
    //             GroupManager.group_info['appointments'][j]['id'],
    //             // 'kk','ii','iil','oo','pp'
    //           );
    //         }
    //       });
                ...
                onTap: check_connectivity(context) == false
                    ...
                    ? () async {
                        ...
                        if (is_ok == true) {
                          ...
                          _showErrorDialog('الطالب غير مسجل في المجموعة','غير مسجل');
                        }
                      }
                    : () async {
                        setState(() {
